...
GH_QUERIES = [
    ...
    ' "/api/v1/client/subscribe?token=" extension:php ', # 针对旧版 V2Board
    ' "/sub?target=clash&url=" ',                        # 针对转换器链接
    ' filename:config.json "outbounds" AND "selector" ', # 针对 Sing-box 格式
    ' "proxy-providers" AND "http" extension:yaml ',     # 针对 Clash 外部资源
    ' "vmess://" AND "remark" extension:txt fork:false ', # 排除 Fork 提高质量
    ' filename:.env "SUB_URL=" '                         # 针对环境变量泄露
]
